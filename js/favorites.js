...
//classe que vai conter a lógica dos dados, ou seja, como são estrutrados.
export class Favorites {
    constructor (root)  {
        this.root = document.querySelector(root)
        this.load()

        GithubUser.search('danielchessahl').then(user => console.log(user))
    }
    ...
    delete (user){
        //Higuer-order functions (map, filter, find, reduce)
...
export class FavoritesView extends Favorites {  
    ...
    createRow () {
        ...
        tr.innerHTML = `
            <td class="user">
                <img src="https://github.com/danielchessahl.png" alt="">
                <a href="https://github.com/danielchessahl" target="_blank">
                    <p>Daniel H Chessa Lourena</p>
                    <span>danielchessahl</span>
                </a>
            </td>
